...
public:
    ...
    void set_socket(std::unique_ptr<tr_peer_socket> socket_in);

    [[nodiscard]] TR_CONSTEXPR23 auto is_utp() const noexcept
    {
    ...
    [[nodiscard]] TR_CONSTEXPR23 auto const& address() const noexcept
    {
        return socket_->address();
    }

    [[nodiscard]] TR_CONSTEXPR23 auto const& socket_address() const noexcept
    {
...
private:
    ...
    std::unique_ptr<tr_peer_socket> socket_;
