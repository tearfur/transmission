...
{
    map.try_emplace(TR_KEY_speed_limit_down, saveSingleSpeedLimit(tor, TR_DOWN));
    map.try_emplace(TR_KEY_speed_limit_up, saveSingleSpeedLimit(tor, TR_UP));
}
