...
#define tr_return_val_if_true(expr, val) \
    do \
    { \
        if (expr) \
        { \
...
{
    tr_return_if_true(!tr_isTorrent(tor));
...
{
    tr_return_val_if_true(!tr_isTorrent(tor), {});
...
{
    tr_return_if_true(!std::ranges::all_of(torrents_in, tr_isTorrent));
...
{
    tr_return_if_true(torrents_in.empty() || !std::ranges::all_of(torrents_in, tr_isTorrent));
...
{
    tr_return_if_true(!tr_isTorrent(tor));
    tr_return_if_true(location == nullptr);
    tr_return_if_true(*location == '\0');
...
{
    tr_return_val_if_true(torrents == nullptr, {});
    tr_return_val_if_true(!std::all_of(torrents, torrents + n_torrents, tr_isTorrent), {});
...
{
    tr_return_if_true(!tr_isTorrent(tor));
    tr_return_if_true(!tr_isPriority(priority));
