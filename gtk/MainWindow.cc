...
void MainWindow::Impl::syncAltSpeedButton()
{
    ...
    alt_speed_button_->set_tooltip_text(
        fmt::format(
            ...
            fmt::arg("download_speed", Speed{ gtr_pref_int_get<size_t>(TR_KEY_alt_speed_down), Speed::Units::KByps }.to_string()),
...
void MainWindow::Impl::onOptionsClicked()
{
    ...
    update_menu(
        ...
        Speed{ gtr_pref_int_get<uint64_t>(TR_KEY_speed_limit_down), Speed::Units::KByps }.to_string(),
        TR_KEY_speed_limit_down_enabled);

    update_menu(
        speed_menu_info_[static_cast<uint8_t>(tr_direction::Up)],
        Speed{ gtr_pref_int_get<uint64_t>(TR_KEY_speed_limit_up), Speed::Units::KByps }.to_string(),
